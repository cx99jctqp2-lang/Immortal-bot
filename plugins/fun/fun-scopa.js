...
*😏 𝐒𝐜𝐞𝐠𝐥𝐢 𝐥𝐚 𝐦𝐨𝐝𝐚𝐥𝐢𝐭à.*`,
  ...
  const sent = await conn.sendMessage(
    chatId,
    {
      text: `*𝐎𝐫𝐚 𝐦𝐢 𝐬𝐜𝐨𝐩𝐨${modeLabel} 𝐚 * ${tag(destinatario)} *😏*`,
...
`   ●█▀█💦‎Ɑ͞ ̶͞ ̶͞ ̶͞ ̶͞ ̶͞ ̶͞ لں͞`
  ...
  await editMessage(
    ...
    chatId,
    key,
    `🥵 *${tag(mittente)} 𝐡𝐚 𝐬𝐜𝐨𝐩𝐚𝐭𝐨${modeLabel} 𝐢𝐥 𝐜𝐮𝐥𝐨 𝐚 ${tag(destinatario)} 𝐢𝐧 ${elapsed} 𝐬𝐞𝐜𝐨𝐧𝐝𝐢, 𝐥𝐚𝐬𝐜𝐢𝐚𝐧𝐝𝐨𝐥𝐚/𝐨 𝐩𝐞𝐫 𝐭𝐞𝐫𝐫𝐚 𝐩𝐢𝐞𝐧𝐚/𝐨 𝐝𝐢 𝐬𝐛𝐨𝐫𝐫𝐚!💦*`,
